...
export function ProfilePage() {
  ...
  const resultsQuery = useQuery({
    ...
    queryFn: () => api.getQuizResults(session, session!.uid),
    enabled: Boolean(session?.uid)
  });

  return (
    <Stack gap="lg">
      <PageHeader eyebrow="Perfil" title="Perfil e progresso" subtitle="Integra perfil, níveis e histórico de resultados enriquecido com título do exame." />

      <Grid>
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Panel className="hero-panel">
            <Title order={3} mb="sm">Conta</Title>
        ...
        <Grid.Col span={{ base: 12, md: 8 }}>
          <Panel>
            <Title order={3} mb="sm">Faixas de nível</Title>
            <Stack gap="xs">
      ...
      <Panel>
        <Title order={3} mb="sm">Histórico de resultados</Title>
        <Stack gap="md">
